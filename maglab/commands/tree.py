...
AREA_ALIASES: dict[str, tuple[str, ...]] = {
    "install": ("Install and workspace",),
    "setup": ("Install and workspace",),
    "manual": ("Install and workspace",),
    "report": ("Install and workspace",),
    "provenance": ("Install and workspace",),
    "prov": ("Install and workspace",),
    "task": ("Install and workspace",),
    ...
    "analysis": ("Research primitives",),
    "analyze": ("Research primitives",),
    "device": ("Research primitives",),
    "fit": ("Research primitives",),
    "material": ("Research primitives",),
    "materials": ("Research primitives",),
    "mat": ("Research primitives",),
    "physics": ("Research primitives",),
    "sim": ("Research primitives",),
    "simulation": ("Research primitives",),
    "authoring": ("Literature and writing",),
    "comms": ("Literature and writing",),
    "explain": ("Literature and writing",),
    "lab": ("Literature and writing",),
    "lit": ("Literature and writing",),
    "figure": ("Figures, instruments, automation",),
    "figures": ("Figures, instruments, automation",),
    "hypotheses": ("Figures, instruments, automation",),
    "instrument": ("Figures, instruments, automation",),
    "instruments": ("Figures, instruments, automation",),
    "instr": ("Figures, instruments, automation",),
    "literature": ("Literature and writing",),
    "mcp": ("Figures, instruments, automation",),
    "present": ("Figures, instruments, automation",),
    "poster": ("Figures, instruments, automation",),
    "presentation": ("Figures, instruments, automation",),
    "deck": ("Figures, instruments, automation",),
    "slides": ("Figures, instruments, automation",),
    "ralph": ("Figures, instruments, automation",),
    "review": ("Literature and writing",),
    "skill": ("Figures, instruments, automation",),
    "skills": ("Figures, instruments, automation",),
    "automation": ("Figures, instruments, automation",),
    "gateway": ("Figures, instruments, automation",),
