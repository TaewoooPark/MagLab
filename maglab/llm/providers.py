...
API_PROVIDER_PROFILES: dict[str, ProviderProfile] = {
    ...
    "kimi": ProviderProfile(
        ...
        routing=_routing("moonshot/kimi-k2.6", "moonshot/kimi-k2.5", "moonshot/kimi-k2.5"),
        prompt_file="kimi.md",
        models=(
            "moonshot/kimi-k2.6",
            "moonshot/kimi-k2.5",
    ...
    "gemini": ProviderProfile(
        ...
        aliases=("google",),
        notes=("Uses Gemini through LiteLLM; old provider name 'google' is accepted as an alias.",),
    ),
...
DELEGATED_MODEL_CHOICES: dict[str, tuple[str, ...]] = {
    "codex": ("gpt-5.5", "gpt-5.3-codex", "gpt-5.2", "gpt-5-mini"),
